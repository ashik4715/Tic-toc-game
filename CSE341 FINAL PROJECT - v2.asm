...
p1turnMessageX db " Player 1's (X) turn, Which Position You Want to Choose?$"
p2turnMessageO db " Player 2's (O) turn, Which Position You Want to Choose?$"
tieMessage db "The Game Tied Between The Two Players!$"
winMessage db "Congratulations!! Congratulations!! The Winner is player $"
sameDigitError db " ERROR!, this place is taken$"
zeroError db " ERROR!,ERROR!,ERROR! input is not a valid digit for the game$" 
line db " *-----------*$"      
...
contCheckTaken proc ; grid[al] == 'O' or 'X'
LEA bx, grid
sub al, 31h
MOV ah, 0
add bx, ax
